...
public interface RandomPaths {
    /**
     * Path to the cache directory where all of the {@code UnsplashRandomFixed}
     * and {@code UnsplashRandomCategorised} class's json files will be saved
     */
    String RAND_JSON_CACHE_SAVE_PATH = RESOURCE_PATH + "/jsoncaches/random";
    /**
     * Path to the random folder where all of the {@code UnsplashRandomFixed}
     * and {@code UnsplashRandomCategorised} class's images files will be saved
     */
    String RAND_IMAGE_SAVE_PATH = RESOURCE_PATH + "/random";
    /**
     * Path to the fixed folder where all of the images from {@code UnsplashRandomFixed}
     * will be saved
     */
    String RAND_IMAGE_FIXED_SAVE_PATH = RAND_IMAGE_SAVE_PATH + "/fixed";
    /**
     * Path to the fixed folder where all of the images from {@code UnsplashRandomCategorised}
     * will be saved
     */
