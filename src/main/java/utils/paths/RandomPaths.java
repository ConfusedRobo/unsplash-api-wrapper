...
public interface RandomPaths {
     ...
     * and {@link RandomTag} class's json files will be saved
     */
     ...
     * and {@link RandomTag} class's images files will be saved
     */
    ...
    /**
     * Path to the fixed folder where all the images from {@link RandomTag}
     * will be saved
     */
